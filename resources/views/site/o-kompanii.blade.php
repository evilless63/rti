...
<section>
    ...
    <main>
        <div class="container-fluid mt-5 mt-md-0 mb-5">
                ...
                <div class="col-md-12 px-lg-5">
                    ...
                    <div class="card pb-5 mx-md-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="container">
                                <!-- Section heading -->
                                <h2 class="font-weight-bold my-5 text-center">О компании</h2>

                                <!-- Section description -->
                                <p class=" w-responsive text-center mx-auto mb-5">Наша миссия, сотрудники и достижения</p>
                                <!-- Section: About 1 -->
                                    ...
                                    <div class="row pt-2 mt-5">
                                        ...
                                        <div class="col-lg-6 ml-auto col-md-12 wow fadeIn" data-wow-delay="0.4s">
                                            ...
                                            <h3 class="mb-5  title font-weight-bold wow fadeIn"
                                                data-wow-delay="0.2s">
                                                <strong>Надежный поставщик РТИ в волгоградской области</strong>
                                            </h3>
            ...
            style="background-image: url('img/backgrounds/page_bg2.jpg');">
